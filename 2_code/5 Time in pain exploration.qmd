...
Conclusion is that it is unlikely that the fish stunning intervention can have an impact that comes close to the impact (in terms of duration affected) of chicken campaigns for annoying, hurtful or disabling pain. For these pain intensities, whether or not fish stunning appears to avert more time in pain appears to be entirely driven by uncertainty of whether the chicken intervention increases or decreases time in pain.
